...
In order to use Java-Semver you will need to download it using a BuildTool like Maven or Gradle. We also highly recommend relocating/shading the library into your own package. 
...
Well done! Next up have a look at all the available [Usage](./usage.mdx).